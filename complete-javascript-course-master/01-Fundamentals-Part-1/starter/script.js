...
if (calcMarkBMI2 > johnMarkBMI2) {
  console.log(
    `Mark's BMI is ${calcMarkBMI2} is higher that John's is ${johnMarkBMI2}`
  );
} else {
  console.log(
    `John's BMI is ${johnMarkBMI2} is higher that Mark's is ${calcMarkBMI2}`
  );
}
...
if (dolphins > koalas) {
  console.log(
    `Los Dolphins ganaron con ${dolphins} y los Koalas perdieron con ${koalas}`
  );
} else if (koalas > dolphins) {
  console.log(
    `Los Koalas ganaron con ${koalas} y los Dolphins perdieron con ${dolphins}`
  );
...
if (scoreDolphins1 >= 100 && scoreDolphins1 > scoreKoalas1) {
  console.log(
    `Ganaron los Dolphins con ${scoreDolphins1} y perdieron los Koalas con ${scoreKoalas1}`
  );
} else if (scoreKoalas1 >= 100 && scoreKoalas1 > scoreDolphins1) {
  console.log(
    `Garaon los Koalas con ${scoreKoalas1} y los Dolphins perdieron con ${scoreDolphins1}`
  );
}
